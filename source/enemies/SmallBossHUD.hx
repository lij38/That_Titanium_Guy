...
class SmallBossHUD extends FlxTypedGroup<FlxSprite>
{
    private var _sprHealth:FlxSprite;
    private var _healthbar:FlxBar;

    public function new(_smallboss:SmallBoss)
     {
         super();
         ...
         //health bar
        _healthbar = new FlxBar(120, 350, 400, 15, _smallboss, "health", 0, 500);
