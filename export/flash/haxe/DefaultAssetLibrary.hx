...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/j.png", __ASSET__assets_images_j_png);
		type.set ("assets/images/j.png", AssetType.IMAGE);
		className.set ("assets/images/n.png", __ASSET__assets_images_n_png);
		type.set ("assets/images/n.png", AssetType.IMAGE);
		className.set ("assets/images/p.png", __ASSET__assets_images_p_png);
		type.set ("assets/images/p.png", AssetType.IMAGE);
		...
		className.set ("assets/images/v.png", __ASSET__assets_images_v_png);
		type.set ("assets/images/v.png", AssetType.IMAGE);
		...
		type.set (id, AssetType.IMAGE);
		id = "assets/images/j.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/n.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/p.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_j_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_n_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_p_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_v_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:file("assets/data/level1.tmx") #if display private #end class __ASSET__assets_data_level1_tmx extends lime.utils.Bytes {}
...
@:image("assets/images/j.png") #if display private #end class __ASSET__assets_images_j_png extends lime.graphics.Image {}
@:image("assets/images/n.png") #if display private #end class __ASSET__assets_images_n_png extends lime.graphics.Image {}
@:image("assets/images/p.png") #if display private #end class __ASSET__assets_images_p_png extends lime.graphics.Image {}
...
@:image("assets/images/v.png") #if display private #end class __ASSET__assets_images_v_png extends lime.graphics.Image {}
